...
#define STRING_CONFIG_H_AUTHOR "(Trip S, Ender-5Pro 5Oct2021)" // Who made the changes.
 ...
 */
#define Z_MIN_PROBE_PIN PB1 // Pin 32 is the RAMPS default Creality 4.2.7 - PB1
